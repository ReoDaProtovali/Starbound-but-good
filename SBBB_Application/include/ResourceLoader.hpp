...
public:
	...
	*/
	std::shared_ptr<Texture> getTexture(TextureID p_ID);
	...
	*/
	std::shared_ptr<Texture> getTexture(TextureID p_ID, bool& p_success); // friendlier, success bool is passed by reference
